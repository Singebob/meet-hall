export type Config = {
  ...
  const envVariablesList = [
    ...
    { name: "POSTGRAPHILE_DATA_MANAGEMENT_USER_NAME", type: String, optional: false },
    { name: "POSTGRAPHILE_DATA_MANAGEMENT_USER_PASSWORD", type: String, optional: false },
    { name: "POSTGRAPHILE_FULL_ACCESS_USER_NAME", type: String, optional: false },
    { name: "POSTGRAPHILE_FULL_ACCESS_USER_PASSWORD", type: String, optional: false },
